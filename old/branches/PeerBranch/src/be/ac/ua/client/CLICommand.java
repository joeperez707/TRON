...
import be.ac.ua.commands.Shutdown;
...
public enum CLICommand {
	...
	private static class ShutdownAction implements Action {

		@Override
		public void exec(Console console, String[] params, Client client) throws Exception {
			if (params[0] != null){
				client.AddCommand(new Shutdown(Integer.parseInt(params[0])));
			}
			else {
				throw new Exception("Not enough parameters: node id is missing");
			}	
		}
	}
